...
dnf -y --comment="Additional software for AMD GPU" install xorg-x11-drv-amdgpu mesa-vdpau-drivers
dnf -y --comment="Gaming tools" install lutris protontricks "wine*"
