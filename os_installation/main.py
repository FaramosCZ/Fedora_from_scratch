...
# PREPARED MOUNTS
LABEL=BTRFS-{random_hash}  /mnt/BTRFS-ROOT   btrfs  noatime,subvol=/,X-mount.mkdir,noauto  0  0
'''
...
shell_cmd(f'echo y | cp -H --remove-destination /etc/resolv.conf {mountpoint_path}/etc/ ')
